...
<div class="grid-2">
  <div class="card card-pad" style="text-align:center">
    ...
    <div style="font-size:11.5px;color:var(--muted2);margin-top:16px">JPG, PNG, GIF or WEBP · up to 3MB</div>
  </div>
...
.profile-av{width:84px;height:84px;border-radius:50%;background:linear-gradient(135deg,var(--glow),var(--gold));
  display:flex;align-items:center;justify-content:center;font-weight:700;font-size:28px;color:#062420;overflow:hidden;
  box-shadow:0 0 0 3px rgba(94,234,212,.15), 0 12px 30px rgba(3,8,7,.4)}
...
.avatar-zoom-bg{position:fixed;inset:0;background:rgba(6,12,10,.85);backdrop-filter:blur(6px);z-index:300;
  display:none;align-items:center;justify-content:center;padding:30px}
.avatar-zoom-bg.show{display:flex}
.avatar-zoom-bg img{max-width:90vw;max-height:85vh;border-radius:20px;box-shadow:0 30px 80px rgba(3,8,7,.6);cursor:zoom-out}
</style>
