...
<div class="app">
  ...
  <div class="modal-bg" id="sidebarBg" onclick="toggleSidebar(false)" style="z-index:45;display:none"></div>
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sb-nav">
      ...
      <a href="chat.php" class="<?php echo navClass('chat',$activeNav); ?>">
        <svg viewBox="0 0 24 24"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
        Messages
      </a>
      <a href="groups.php" class="<?php echo navClass('groups',$activeNav); ?>">
